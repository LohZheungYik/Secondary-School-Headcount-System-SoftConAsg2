...
<t:genericpage>
    <jsp:body>
        ...
        <script src="/js/ManageStudent/saveStudent.js"></script>
        ...
        <div class="title-box">
            <div class="title-text">
                ...
                <h3 class="title mdc-typography--headline2">Borang Penambahan Pelajar Baru</h3>
            </div>
        </div>
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" type="text" name="ic" id="ic" placeholder="98010108942" required>
                        <br>
                    </div>
                </div>
