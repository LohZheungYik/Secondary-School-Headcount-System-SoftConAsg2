...
<t:genericpage>
    <jsp:body>
        ...
        <script src="/js/ManageAdmin/saveAdminEdit.js"></script>
        ...
        <input type="hidden" id="adminId" name="adminId" value="${message}" />

        <div class="title-box">
            <div class="title-text">
                <h3><i onclick="window.location.href='/admin/index'" class="pure-material-button-contained back-btn fa fa-arrow-left"></i></h3>
                <h3 class="title mdc-typography--headline2">Borang Penyuntingan Maklumat Penyelia</h3>
            </div>
        </div>
                ...
                <h5>Maklumat Peribadi</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <input class="form-control" type="text" name="username" id="username" placeholder="contoh: ali233" readonly="readonly" required>
                                <br>
                            </div>
                        </div>
